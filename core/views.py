        ...
        try:
            ...
            if form.is_valid():
                ...
                if payment_option == 'S':
                    ...
                    return redirect('core:core-webpay-create')
...
class CreateWebpayPlusTransactionView(View):
    """
    ...
    def get(self, request):
        ...
        response = transaction_instance.create(buy_order, session_id, amount, return_url)
        ...
        return render(request, 'core/webpay_create.html', context)


class WebpayPlusCommitView(View):
    """
    Commits a Webpay Plus transaction.
    """

    @csrf_exempt
    def get(self, request):
        token = request.GET.get("token_ws")
        print(f"commit for token_ws: {token}")
